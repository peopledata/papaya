import {
  ...
  export default class RegistryContract {
    ...
    /**
     * Resolves a DID on the Peopledata Registry Contract. Checks if an entry for this DID exists and returns the related
     * IPFS hash if so.
     ...
     * @throws if the DID does not have a "peopledata did" method identifier or if no Did Document was found
     * @example registryContract.resolveDID("did:peopledata:1fb352353ff51248c5104b407f9c04c3666627fcf5a167d693c9fc84b75964e2")
     */
     ...
     *
     * @param did - the DID to be anchored, e.g. did:peopledata:accf...eed
  ...
  function stripMethodPrefix(did: string) {
    if (did.indexOf('peopledata') === -1) throw 'Only "peopledata" DIDs are allowed';
